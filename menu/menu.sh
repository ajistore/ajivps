...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ipvps > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ipvps | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ipvps | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/ajistore/permission/main/ipvps | grep $MYIP | awk '{print $3}')
fi
...
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite} AJITUNNEL ${NC}"
echo -e "${BICyan} │"
...
echo -e "${BICyan} │  ${BICyan}WHATSAP   :  ${BIYellow}083130791995${NC}"
echo -e "${BICyan} │  ${BICyan}DEVELOVER :  ${BIYellow🥵}AJI VPN🥵${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}" 
